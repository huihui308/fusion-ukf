...
void MeasurementPredictor::initialize(
...
MatrixXd MeasurementPredictor::compute_sigma_z(
...
MatrixXd MeasurementPredictor::compute_S(
...
void MeasurementPredictor::process(
    const MatrixXd& sigma_x,
    const DataPointType sensor_type)
{
