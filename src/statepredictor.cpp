...
MatrixXd StatePredictor::predict_sigma(
    const MatrixXd& augmented_sigma,
    double dt)
{
...
VectorXd StatePredictor::predict_x(
    const MatrixXd& predicted_sigma)
{
...
MatrixXd StatePredictor::predict_P(
    const MatrixXd& predicted_sigma,
